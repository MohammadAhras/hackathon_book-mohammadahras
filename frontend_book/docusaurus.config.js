...
const config = {
  title: 'ROS 2 Robotics Module',
  tagline:
    'Learn ROS 2 fundamentals, Python agents with rclpy, and humanoid modeling with URDF',
  favicon: 'img/favicon.ico',

  // ✅ VERCEL CONFIG (IMPORTANT)
  url: 'https://hackathon-book.vercel.app', // replace with your real Vercel domain
  baseUrl: '/',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} ROS 2 Robotics Module.`,
    },
